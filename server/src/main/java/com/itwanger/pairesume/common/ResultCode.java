...
public enum ResultCode {
    ...
    RESUME_REVIEW_FOLLOW_REWARD_EXISTS(7507, "当前账号已领取过关注奖励"),
    RESUME_REVIEW_FOLLOW_CODE_INVALID(7508, "关注奖励凭证无效或已失效"),
    RESUME_REVIEW_FOLLOW_BRIDGE_INVALID(7509, "公众号关注验证事件无效"),
    RESUME_REVIEW_REFUND_REFERENCE_CONFLICT(7510, "人工精修退款流水已被使用"),
    RESUME_REVIEW_FOLLOW_REQUIRED(7511, "第二次精修请先关注沉默王二公众号领取一次免费机会"),
