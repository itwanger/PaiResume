  ...
  return (
    ...
    >
      ...
      <PolicySection title="二、我们处理的信息">
        ...
        <p>申请人工精修时，我们会处理你确认提交时的简历快照、联系邮箱、授权记录、申请与处理状态。领取第二次免费机会时，“沉默王二”公众号会通过受信桥接返回挑战核验结果；该公众号与用于登录的“派聪明”服务号是两个独立渠道。</p>
      </PolicySection>
      ...
      <PolicySection title="四、共享、公开与支付">
        ...
        <p>只有在你单独确认申请人工精修后，平台才会从服务端生成该次申请对应的 PDF，并发送到平台配置的固定人工审阅邮箱。邮件收件人会据此查看简历并提供人工服务；已经由邮件系统接受的邮件无法由平台远程召回，请在提交前再次检查联系方式和其他敏感内容。</p>
      ...
      <PolicySection title="五、保存、安全与个人权利">
        ...
        <p>人工精修快照和处理记录会在完成服务、处理售后及履行法定义务所需期限内保存，之后删除快照或作匿名化处理。存在待支付、待发送、处理中或待退款的人工精修申请时，需要先处理完毕才能注销账号；已发送至人工审阅邮箱的副本不具备远程召回能力。</p>
  ...
  return (
    ...
    >
      ...
      <PolicySection title="四、付费、退款与服务变更">
        ...
        <p>人工精修按服务端记录的有效申请计次：首次可免费申请一次；第二次需完成页面所示的“沉默王二”公众号挑战核验后获得一次免费机会；此后每次申请均需单独支付。关注“派聪明”服务号仅用于扫码登录，不等同于领取第二次免费机会。</p>
        <p>提交人工精修前，平台会等待当前编辑内容保存，并对当时的服务端简历生成不可变快照。后续继续修改在线简历，不会自动改变已经提交或发送的申请内容。</p>
