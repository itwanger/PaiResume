  ...
  return (
    ...
    >
      ...
      <PolicySection title="二、我们处理的信息">
        ...
        <p>平台会从你已自动保存的历史简历中汇总可复用内容，方便你在本人账号下填写其他简历。个人资料库仅限登录本人查看和使用，不会混入官方参考内容。</p>
      ...
      <PolicySection title="四、共享、公开与支付">
        ...
        <p>只有在你从本地选择已经导出的 PDF 并点击发送后，浏览器才会把该 PDF 提交给平台。服务端在内存中核验文件名、大小、类型、文件头和摘要后，立即作为附件发送到管理后台配置的人工审阅邮箱，不保存到平台对象存储或服务器本地磁盘。已经由邮件系统接受的邮件无法由平台远程召回，请在提交前检查文件内容和敏感信息。</p>
        <p>人工精修页面会公开展示脱敏申请编号、排队位置、处理状态、付款时间、实付金额和加急金额，用于说明队列排序；不会公开姓名、邮箱、简历内容、完整订单号或支付交易号。</p>
      ...
      <PolicySection title="五、保存、安全与个人权利">
        ...
        <p>人工精修 PDF 不保存在平台对象存储或服务器本地磁盘；申请、计费和审计记录会在完成服务、处理售后及履行法定义务所需期限内保留。存在待支付、待发送、处理中或待退款的人工精修申请时，需要先处理完毕才能注销账号；已发送至人工审阅邮箱的副本不具备远程召回能力。</p>
  ...
  return (
    ...
    >
      ...
      <PolicySection title="四、付费、退款与服务变更">
        ...
        <p>人工精修仅对有效派简历会员开放。会员可以免费进入普通队列；选择加急插队时，才需要按页面选择或填写的加急金额单独支付。</p>
        <p>尚未开始精修的申请按加急金额从高到低排列，同金额按付款时间排列；普通申请按提交时间排在加急申请之后。已经开始精修的申请不会因后来申请支付更高金额而被替换。加急只改变等待顺序，不承诺具体完成时间。</p>
        <p>提交人工精修前，你需要从本地选择已经导出的 PDF。普通排队点击发送后立即投递附件；加急排队在支付成功后投递附件。后续修改在线简历不会改变已经发送的内容。</p>
  ...
  return (
    ...
    >
      ...
      <PolicySection title="二、数字化权益的特别说明">
        ...
        <p>人工精修加急服务按单次申请交付。尚未将简历发送至人工审阅邮箱、重复扣款或系统无法交付时，可以申请退款；简历已经发送且人工处理已经开始后，会结合实际完成的服务、问题原因和适用法律核验，不承诺按“未使用”退款。</p>
        <p>加急金额作为本次申请的独立订单金额固化；符合退款条件时按该订单实际支付金额核验。</p>
      </PolicySection>
