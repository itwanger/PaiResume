...
export function normalizeEducationContent(content: Record<string, unknown>): EducationContent {
  ...
  return {
    ...
    academicPerformance: toStringValue(record.academicPerformance),
    majorCourses: toStringValue(record.majorCourses),
    languageProficiency: toStringValue(record.languageProficiency),
